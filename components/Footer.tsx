...
const socialLinks = [
  { name: 'GitHub', url: 'https://github.com/Borion-Client', icon: FiGithub },
  { name: 'Discord', url: 'https://discord.gg/borion', icon: FiMessageCircle },
  { name: 'YouTube', url: 'https://www.youtube.com/@BorionClient', icon: FiYoutube },
]
